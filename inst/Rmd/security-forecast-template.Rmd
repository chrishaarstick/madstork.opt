...
# R packages
packages <- c("a2munge", "a2modeler", "a2charter", "dplyr", "tidyr", "readxl", "tibble", "purrr", "ggplot2", "forcats", "stringr", "lubridate", "sparklyr", "rlang", "madstork", "madstork.opt", "here", "ggrepel")
...
```{r execution, eval=TRUE, ref.label=c('r-config', 'r-setup', 'spark-config', 'spark-setup', 'portfolio-config', 'estimates-config', 'prediction-config', 'load-objects', 'estimates', 'data-prep',  'spark-import', 'feature-pipeline', 'regressor', 'predictions')}
```
...
preds_sum %>%
    ...
    geom_text_repel() +
    geom_hline(linetype = 5, color = "grey75", yintercept = mkt_preds$predicted) +
